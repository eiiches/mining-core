...
import jp.thisptr.core.lambda.alias.BinaryFunction;
import jp.thisptr.core.lambda.alias.Lambda;
import jp.thisptr.core.tuple.Pair;
import jp.thisptr.core.tuple.Tuple;
import jp.thisptr.core.util.CollectionUtils;
import jp.thisptr.core.util.ReflectUtils;
...
public final class Lambdas {
	...
	public static <T> Lambda1<T, String> valueOf(final Class<T> klass) {
		return Lambda1.fromStaticMethod(ReflectUtils.getMethod(klass, "valueOf", String.class));
	}
