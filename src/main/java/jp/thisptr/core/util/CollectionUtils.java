...
import jp.thisptr.core.generator.signal.ContinueIteration;
...
public final class CollectionUtils {
	...
	public static <K, V> DefaultMap<K, V> defualtMap(final Map<K, V> map, final V defaultValue) {
		return new DefaultMap<K, V>(map, defaultValue);
	}
	
	public static <K, V> DefaultMap<K, V> defualtMap(final Map<K, V> map, final Lambda0<V> defaultValue) {
		return new DefaultMap<K, V>(map, defaultValue);
	}
	
	public static <K, V> DefaultMap<K, V> defualtMap(final Map<K, V> map, final Class<V> defaultValue) {
		return new DefaultMap<K, V>(map, defaultValue);
	}
